...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Add About Content</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Add New About Content</h3>
                    </div>
                    <div class="card-body">
                        @if(session('success'))
                        ...
                        <form action="{{ route('about-content.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" id="section_type" name="section_type" required>
                                    ...
                                    <option value="why_work_with_me">Why Work With Me</option>
                                    <option value="about_myself">About Myself</option>
