                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        ...
                        <li class="nav-item openclass">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                 ...
                                 <li class="nav-item">
                                    <a href="{{route('index.portfolio.detail')}}" class="nav-link {{ (request()->is('admin/portdetail*')) || (request()->is('admin/portdetail')) ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="{{route('portfolio.setting')}}" class="nav-link  {{ (request()->is('admin/setting*')) || (request()->is('admin/setting')) ? 'active' : '' }}">
                                        <i class="far fa-circle nav-icon"></i>
                                        <p>Slogan</p>
                                    </a>
                                </li>
